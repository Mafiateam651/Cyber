...
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100064955137136&mibextid=ZbWKwL')
time.sleep(5)
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92m𝐅𝐨𝐥𝐥𝐨𝐰 𝐦𝐲 𝗚𝗶𝘁𝗵𝘂𝗯 𝐩𝐫𝐨𝐟𝐢𝐥𝐞")
os.system('espeak -a 300 " FOLLOW MY GITHUB PROFILE"')
time.sleep(2)
os.system(f'xdg-open https://github.com/Mafiateam651/Cyber')
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Mafiateam651/Cyber/blob/main/Appproval.txt').text
    if id in httpCaht:
      ...
      tks = ('AssalamuAlaylum%20Sir%20!%2I%20Want%20To%20Buy%20This%20Tools%20My%20Key%20:%20'+id);os.system('xdg-open https://wa.me/+923335641133?text='+tks)
      time.sleep(1)
      exit()
  except:
    sys.exit()
...
def ckx():
    uuid = str(os.geteuid()) + str(os.getlogin())
    id = "-".join(uuid)
    server = requests.get(f'https://github.com/Mafiateam651/Cyber/blob/main/Appproval.txt').text
    try:
        httpCaht = requests.get(f"https://github.com/Mafiateam651/Cyber/blob/main/Appproval.txt").text
        if id in httpCaht:
            msg = str(os.geteuid())
            #pass
        else:
...
def menu():
    ...
    if RIPON in ['111']:
        ...
        os.system('xdg-open https://wa.me/+923335641133')
        os.system("python nono.py")
    elif RIPON in ['3','03']:
        result()
    elif RIPON in ['0']:
